...
class LoginPage(BasePage):
    ...
    def login_visibility(self):
        login_verify =  self.find_element(self.LOGIN_BUTTON)
        if login_verify.is_displayed() and login_verify.is_enabled():
            return True
        else:
            return False
    ...
    def sign_up_visibility(self):
        sign_up_verify = self.find_element(self.SIGN_UP)
        if sign_up_verify.is_displayed() and sign_up_verify.is_enabled():
            return True
        else:
            return False
